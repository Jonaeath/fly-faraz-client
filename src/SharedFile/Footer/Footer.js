            ...
            <footer className="footer footer-center p-10 bg-sky-600 text-primary-content">
                <div>
                    ...
                    <p className="font-bold text-primary-content">
                        FLY FARAZ Aviation. <br />Providing reliable tech since 2022
                    </p>
                    <p className='text-primary-content'>Pasdona - Madabdi - Narsingdi </p>
                </div>
                <div>
                    <div className="grid grid-flow-col gap-4 text-primary-content">
